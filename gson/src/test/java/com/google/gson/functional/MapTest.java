...
public class MapTest {
  ...
  public void testMapSerialization() {
    ...
    map.put("a", 1);
    map.put("b", 2);
    Type typeOfMap = new Gson.TypeToken<Map<String, Integer>>() {}.getType();
  ...
  public void testMapSerializationWithIntegerKeys() {
    ...
    map.put(123, "456");
    Type typeOfMap = new Gson.TypeToken<Map<Integer, String>>() {}.getType();
    String json = gson.toJson(map, typeOfMap);
  ...
  public void testMapDeserializationWithLongKeys() {
    ...
    Type typeOfMap = new Gson.TypeToken<Map<Long, String>>() {}.getType();
  ...
  public void testHashMapDeserialization() throws Exception {
    Type typeOfMap = new Gson.TypeToken<HashMap<Integer, String>>() {}.getType();
  ...
  public void testSortedMap() throws Exception {
    Type typeOfMap = new Gson.TypeToken<SortedMap<Integer, String>>() {}.getType();
  ...
  public void testConcurrentMap() throws Exception {
    Type typeOfMap = new Gson.TypeToken<ConcurrentMap<Integer, String>>() {}.getType();
  ...
  public void testConcurrentHashMap() throws Exception {
    Type typeOfMap = new Gson.TypeToken<ConcurrentHashMap<Integer, String>>() {}.getType();
  ...
  public void testConcurrentNavigableMap() throws Exception {
    Type typeOfMap = new Gson.TypeToken<ConcurrentNavigableMap<Integer, String>>() {}.getType();
  ...
  public void testConcurrentSkipListMap() throws Exception {
    Type typeOfMap = new Gson.TypeToken<ConcurrentSkipListMap<Integer, String>>() {}.getType();
  ...
  public void testParameterizedMapSubclassSerialization() {
    ...
    map.put("a", "b");
    Type type = new Gson.TypeToken<MyParameterizedMap<String, String>>() {}.getType();
  ...
  public void testMapStandardSubclassDeserialization() {
    String json = "{a:'1',b:'2'}";
    Type type = new Gson.TypeToken<LinkedHashMap<String, String>>() {}.getType();
  ...
  public void testMapSerializationWithWildcardValues() {
    ...
    map.put("test", null);
    Type typeOfMap =
        new Gson.TypeToken<Map<String, ? extends Collection<? extends Integer>>>() {}.getType();
    String json = gson.toJson(map, typeOfMap);
  ...
  public void testMapDeserializationWithWildcardValues() {
    Type typeOfMap = new Gson.TypeToken<Map<String, ? extends Long>>() {}.getType();
  ...
  public void testMapOfMapDeserialization() {
    ...
    Type type = new Gson.TypeToken<Map<String, Map<String, String>>>(){}.getType();
  ...
  public void testReadMapsWithEmptyStringKey() {
    Map<String, Boolean> map = gson.fromJson("{\"\":true}", new Gson.TypeToken<Map<String, Boolean>>() {}.getType());
  ...
  public void testComplexKeysSerialization() {
    ...
    assertEquals(json, gson.toJson(map, new Gson.TypeToken<Map<Point, String>>() {}.getType()));
  ...
  public void testComplexKeysDeserialization() {
    String json = "{'2,3':'a','5,7':'b'}";
    try {
      gson.fromJson(json, new Gson.TypeToken<Map<Point, String>>() {}.getType());
      fail();
  ...
  public void testStringKeyDeserialization() {
    ...
    map.put("2,3", "a");
    map.put("5,7", "b");
    assertEquals(map, gson.fromJson(json, new Gson.TypeToken<Map<String, String>>() {}.getType()));
  }
  ...
  public void testNumberKeyDeserialization() {
    ...
    map.put(2.3, "a");
    map.put(5.7, "b");
    assertEquals(map, gson.fromJson(json, new Gson.TypeToken<Map<Double, String>>() {}.getType()));
  }
  ...
  public void testBooleanKeyDeserialization() {
    ...
    map.put(true, "a");
    map.put(false, "b");
    assertEquals(map, gson.fromJson(json, new Gson.TypeToken<Map<Boolean, String>>() {}.getType()));
  }

  @Test
  public void testMapDeserializationWithDuplicateKeys() {
    try {
      gson.fromJson("{'a':1,'a':2}", new Gson.TypeToken<Map<String, Integer>>() {}.getType());
      fail();
  ...
  public void testMapNamePromotionWithJsonElementReader() {
    ...
    assertEquals(map, gson.fromJson(tree, new Gson.TypeToken<Map<Double, String>>() {}.getType()));
  }
